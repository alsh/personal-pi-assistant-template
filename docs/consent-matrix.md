...
|---|---|---|---|
| Local document roots | Committed synthetic fixture plus private `PA_DATA_DIR/documents` | Rename, move, and tag only through proposal plus immediate confirmation | Active |
